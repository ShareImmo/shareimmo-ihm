...
import viewBien from './images/viewBien.png';
...
const ShareImmoBlog = () => {
  ...
  return (
    ...
    <div style={{width: '55%', textAlign: 'justify', alignItems:'center', justifyContent: 'center',  margin: '0 auto'}} className="blog-article">
      <h6 style={titleStyle}>Découvrez les Avantages Révolutionnaires de l'Immobilier Tokénisé avec ShareImmo</h6>
      <br/>
            <img src={viewBien} alt="logo" style={{display: 'block', margin: '0 auto', width: '100%'}} />
            <br/>
	  <p style={paraStyle}>
      ...
      <br/>
	  <h3 style={subsubtitleStyle}><i class="fas fa-star"></i>&nbsp;&nbsp;Accessibilité et Diversification</h3>
	  <p style={paraStyle}>
	  ...
	  <h3 style={subsubtitleStyle}><i class="fas fa-star"></i>&nbsp;&nbsp;Liquidité Augmentée</h3>
	  <p style={paraStyle}>
	  ...
	  <h3 style={subsubtitleStyle}><i class="fas fa-star"></i>&nbsp;&nbsp;Transparence et Sécurité</h3>
	  <p style={paraStyle}>
	  ...
	  <h3 style={subsubtitleStyle}><i class="fas fa-star"></i>&nbsp;&nbsp;Coûts Réduits</h3>
	  <p style={paraStyle}>
